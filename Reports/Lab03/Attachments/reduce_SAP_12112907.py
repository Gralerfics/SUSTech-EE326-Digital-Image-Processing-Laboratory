...
def reduce_SAP_12112907(img, radius): # radius should be an integer and larger than 1
    size = radius * 2 - 1
...
img_raw = loadGrayscaleAsNumpy("Q3_4.tif")
start = time.time()
img = reduce_SAP_12112907(img_raw, 2)
